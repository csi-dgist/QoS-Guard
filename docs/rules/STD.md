...
.md-typeset table td:first-child {
    ...
    text-align: center !important; /* 내부 요소를 중앙으로 보냄 */
    vertical-align: middle !important;
}

/* 2. 숫자 배지 - 가로 늘어남(타원) 방지 핵심 설정 */
.md-typeset table td:first-child,
.md-typeset table td:first-child a {
    display: inline-flex !important; /* inline-flex가 너비 유지에 더 유리합니다 */
    ...
    min-width: 26px !important; /* 최소 너비 고정 */
    max-width: 26px !important; /* 최대 너비 고정 (타원 방지 핵심!) */
    
    margin: 8px auto !important; /* 상하 여백을 주어 중앙 배치 */
